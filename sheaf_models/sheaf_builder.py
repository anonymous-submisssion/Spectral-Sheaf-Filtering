...
from layers.orthogonal import Orthogonal
import utils.sheaf_utils
from sheaf_models.sheaf_models import MLP
...
class SheafBuilderLowRank(nn.Module):
    ...
    def forward(self, x, e, hyperedge_index, debug=False):
        ...
        if self.norm_type == 'block_norm':
            ...
            d_sqrt_inv_nodes = models.sheaf_utils.batched_sym_matrix_pow(to_be_inv_nodes, -1.0) #n_nodes x d x d
            d_sqrt_inv_edges = models.sheaf_utils.batched_sym_matrix_pow(to_be_inv_edges, -1.0) #n_edges x d x d
